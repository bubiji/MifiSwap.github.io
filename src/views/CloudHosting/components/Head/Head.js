...
const mock = [
  {
    title: '本地器件数据库',
    subtitle: '多种方式的数据导入与创建，强大专业的搜索能力',
    icon: (
      <svg width={
        24
      } height={
  ...
  {
    title: '器件质量事件数据库',
    subtitle:'质量事件相关的全要素入库，针对具体器件快速查询',
    icon: (
      <svg
        height={24}
        width={24}
  ...
  {
    title: '器件风险告警平台',
    subtitle: '从器件与器件应用产品两个维度进行订阅与告警',
    icon: (
      <svg
        height={24}
        width={24}
